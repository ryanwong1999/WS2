...
#include "yzbot_msgs/msg/detail/psc_head_offset__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const yzbot_msgs::msg::PscHeadOffset *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yzbot_msgs::msg::PscHeadOffset *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PscHeadOffset__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const yzbot_msgs::msg::PscHeadOffset *>(
...
{
  return max_serialized_size_PscHeadOffset(full_bounded, 0);
}

static message_type_support_callbacks_t _PscHeadOffset__callbacks = {
  "yzbot_msgs::msg",
  "PscHeadOffset",
...
static rosidl_message_type_support_t _PscHeadOffset__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PscHeadOffset__callbacks,
...
{
  return &yzbot_msgs::msg::typesupport_fastrtps_cpp::_PscHeadOffset__handle;
}
