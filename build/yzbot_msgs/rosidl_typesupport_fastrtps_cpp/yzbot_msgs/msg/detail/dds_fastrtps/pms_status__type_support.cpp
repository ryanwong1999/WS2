...
#include "yzbot_msgs/msg/detail/pms_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const yzbot_msgs::msg::PmsStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yzbot_msgs::msg::PmsStatus & ros_message)
{
  // Member: pms_charging_flag
  cdr >> ros_message.pms_charging_flag;
...
{
  auto typed_message =
    static_cast<const yzbot_msgs::msg::PmsStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yzbot_msgs::msg::PmsStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PmsStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const yzbot_msgs::msg::PmsStatus *>(
...
{
  return max_serialized_size_PmsStatus(full_bounded, 0);
}

static message_type_support_callbacks_t _PmsStatus__callbacks = {
  "yzbot_msgs::msg",
  "PmsStatus",
...
static rosidl_message_type_support_t _PmsStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PmsStatus__callbacks,
...
{
  return &yzbot_msgs::msg::typesupport_fastrtps_cpp::_PmsStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yzbot_msgs, msg, PmsStatus)() {
  return &yzbot_msgs::msg::typesupport_fastrtps_cpp::_PmsStatus__handle;
}
